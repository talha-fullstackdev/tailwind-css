...
import readers from "/public/reader.png";
import zdnet from "/public/zdnet.png";
import wierd from "/public/wired.png";
const data = [
...
const Craousal = () => {
  return (
    <div className="bg-[#FFC247]  ">
      <div className="max-w-[1440px] w-full pb-[70px] ">
        <div className="max-w-[609] text-[36px] leading-[45px] tracking-[-0.72px] text-[#02033B] font-bold pl-[93px] pt-[83px] ">
          <p className="w-[563.42px] p-2 inter">
            Loved by thousands of iPhone and Android users alike
          </p>
        </div>
        <div className="flex gap-10 justify-center pt-[72px]">
          {data.map((item, index) => (
            <div
              key={index}
              className="w-[400px] pl-[36px] pr-[36px] pt-[36px] pb-[96px] bg-[#FFFFFF] rounded-[48px]  flex-col "
            > 
        ...
        <div className="mt-[50px]">
          <div className="flex items-center px-[96px] ">
            <p className="w-[129px] text-[23px] text-[#02033B] leading-[30px] tracking-[-0.48px] font-bold inter">Featured in:</p>
            <div className="flex ml-[102px] gap-[30px]">
